...
router.put("/:id", validateActionId(), validateActionBody,  (req, res, next) =>{
    ...
    actionsModel.update(req.id, req.body)
    .then(actionsUpdate => {
      console.log("req id ", req.id);
      console.log("whats our req.body", req.body);
      console.log("wats our actionId", req.actionsId);
      console.log("what we getting back", actionsUpdate);
    res.status(200).json(actionsUpdate);
    })
    .catch(err => {
      next(err);
